...
typedef struct
{
    ...
    volatile     T_CACHE_REG_FLASH_BASE_ADDR            reg_flash_base_addr; /*  0x4,    RW, 0x00800000,                  addr Register*/
    volatile        T_CACHE_REG_QSPI_DR_ADDR               reg_qspi_dr_addr; /*  0x8,    RW, 0x20300060,                  addr Register*/
    volatile           T_CACHE_REG_FLASH_CMD                  reg_flash_cmd; /*  0xc,    RW, 0x00000000,         flash command Register*/
...
__STATIC_INLINE void cache_reg_cache_en_unpack(uint8_t* cache_en)
{
...
__STATIC_INLINE void cache_reg_flash_cmd_pack(uint8_t flash_rd_cmd_format, uint8_t flash_rd_data_format, uint8_t flash_rd_addr_format, uint8_t flash_rd_cmd)
{
    hwp_cache->reg_flash_cmd.val = (((uint32_t)flash_rd_cmd_format << 10) | ((uint32_t)flash_rd_data_format << 9) | ((uint32_t)flash_rd_addr_format << 8) | ((uint32_t)flash_rd_cmd << 0));
}

__STATIC_INLINE void cache_reg_flash_cmd_unpack(uint8_t* flash_rd_cmd_format, uint8_t* flash_rd_data_format, uint8_t* flash_rd_addr_format, uint8_t* flash_rd_cmd)
{
