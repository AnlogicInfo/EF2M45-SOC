...
** ELF Header Information
    ...
    Program header offset: 100648 (0x00018928)
    Section header offset: 100680 (0x00018948)
...
** Program header #0
    ...
    Size in file  : 4348 bytes (0x10fc)
    Size in memory: 6932 bytes (0x1b14)
...
** Section #2
    ...
    $d
        0x000000bc:    00001018    ....    DCD    4120
        0x000000c0:    00001038    8...    DCD    4152
    $t
    !!handler_copy
    __scatterload_copy
    ...
    _PrintUnsigned
        ...
        0x00000e4e:    f8df9048    ..H.    LDR      r9,[pc,#72] ; [0xe98] = 0x10c4
    ...
    test_demo
        ...
        0x00001052:    f2427610    B..v    MOV      r6,#0x2710
        0x00001056:    2100        .!      MOVS     r1,#0
        0x00001058:    2010        .       MOVS     r0,#0x10
        0x0000105a:    f7fffb7d    ..}.    BL       HAL_GPIO_WritePin ; 0x758
        0x0000105e:    2082        .       MOVS     r0,#0x82
        0x00001060:    4634        4F      MOV      r4,r6
        0x00001062:    1e64        d.      SUBS     r4,r4,#1
        0x00001064:    d1fd        ..      BNE      0x1062 ; test_demo + 54
        0x00001066:    1e40        @.      SUBS     r0,r0,#1
        0x00001068:    d1fa        ..      BNE      0x1060 ; test_demo + 52
        0x0000106a:    2101        .!      MOVS     r1,#1
        0x0000106c:    2010        .       MOVS     r0,#0x10
        0x0000106e:    f7fffb73    ..s.    BL       HAL_GPIO_WritePin ; 0x758
        0x00001072:    2082        .       MOVS     r0,#0x82
        0x00001074:    4635        5F      MOV      r5,r6
        0x00001076:    1e6d        m.      SUBS     r5,r5,#1
        0x00001078:    d1fd        ..      BNE      0x1076 ; test_demo + 74
        0x0000107a:    1e40        @.      SUBS     r0,r0,#1
        0x0000107c:    d1fa        ..      BNE      0x1074 ; test_demo + 72
        0x0000107e:    a005        ..      ADR      r0,{pc}+0x16 ; 0x1094
        0x00001080:    f7fff878    ..x.    BL       __2printf ; 0x174
        0x00001084:    2011        .       MOVS     r0,#0x11
        0x00001086:    f7fffaab    ....    BL       HAL_GPIO_ReadPin ; 0x5e0
        0x0000108a:    4601        .F      MOV      r1,r0
        0x0000108c:    a009        ..      ADR      r0,{pc}+0x28 ; 0x10b4
        0x0000108e:    f7fff871    ..q.    BL       __2printf ; 0x174
        0x00001092:    e7e0        ..      B        0x1056 ; test_demo + 42
    $d
        0x00001094:    32666c45    Elf2    DCD    845573189
        0x00001098:    55434d20     MCU    DCD    1430474016
        0x0000109c:    69755120     Qui    DCD    1769296160
        0x000010a0:    74736b63    ckst    DCD    1953721187
        0x000010a4:    20747261    art     DCD    544502369
        0x000010a8:    6a6f7250    Proj    DCD    1785688656
        0x000010ac:    7e746365    ect~    DCD    2121556837
        0x000010b0:    0000000a    ....    DCD    10
        0x000010b4:    6f697067    gpio    DCD    1869181031
        0x000010b8:    20315f31    1_1     DCD    540106545
        0x000010bc:    6425203d    = %d    DCD    1680154685
        0x000010c0:    00000a7e    ~...    DCD    2686
    $d.realdata
    .constdata
    _aV2C
        0x000010c4:    33323130    0123    DCD    858927408
        0x000010c8:    37363534    4567    DCD    926299444
        0x000010cc:    42413938    89AB    DCD    1111570744
        0x000010d0:    46454443    CDEF    DCD    1178944579
    Region$$Table$$Base
        0x000010d4:    000010f4    ....    DCD    4340
        0x000010d8:    20000000    ...     DCD    536870912
        0x000010dc:    00000008    ....    DCD    8
        0x000010e0:    000000c4    ....    DCD    196
        0x000010e4:    000010fc    ....    DCD    4348
        0x000010e8:    20000008    ...     DCD    536870920
        0x000010ec:    00000a18    ....    DCD    2584
        0x000010f0:    000000e0    ....    DCD    224
    Region$$Table$$Limit
...
** Section #8
    ...
    Flags       : None (0x00000000)
    Addr        : 0x00000000
    File Offset : 59756 (0xe96c)
    Size        : 7908 bytes (0x1ee4)
    Link        : SHN_UNDEF
    Info        : 0
    Alignment   : 1
    Entry Size  : 0
...
** Section #9
    ...
    Flags       : None (0x00000000)
    Addr        : 0x00000000
    File Offset : 67664 (0x10850)
    Size        : 3380 bytes (0xd34)
    Link        : SHN_UNDEF
    Info        : 0
    Alignment   : 1
    Entry Size  : 0
...
** Section #15
    ...
    Flags       : None (0x00000000)
    Addr        : 0x00000000
    File Offset : 90884 (0x16304)
    Size        : 9584 bytes (0x2570)
    Link        : SHN_UNDEF
    Info        : 0
    Alignment   : 1
    Entry Size  : 0
    ...
    Component: ARM Compiler 5.05 update 2 (build 169) Tool: armasm [4d0f2f]
    armasm --debug --diag_suppress=9931,9931,1602,1073 --cpu=Cortex-M3 --fpu=SoftVFP --apcs=/interwork/interwork --divide  C:\Users\ADMINI~1\AppData\Local\Temp\p58d4-2
    ...
    Component: ARM Compiler 5.05 update 2 (build 169) Tool: armasm [4d0f2f]
    ArmAsm --debug --xref --diag_suppress=9931 --cpu=Cortex-M3 --apcs=interwork --depend=.\objects\startup_elf2.d  -IG:\ELF2_SOC_Shanghai\trunk\Demo\GPIO_Demo\Keil\RTE -IC:\Keil_v5\ARM\PACK\ARM\CMSIS\4.3.0\Device\ARM\ARMCM3\Include -IC:\Kei
    ...
    Component: ARM Compiler 5.05 update 2 (build 169) Tool: armasm [4d0f2f]
    armasm --debug --diag_suppress=9931,9931,1602,1073 --cpu=Cortex-M3 --fpu=SoftVFP --apcs=/interwork/interwork --divide  C:\Users\ADMINI~1\AppData\Local\Temp\p6738-2
