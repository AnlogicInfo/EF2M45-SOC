...
unsigned char TdiBuf[261];			/* Memory to hold TDI data. */

unsigned char TdoBuf[261];			/* Memory to hold TDO data. */
...
extern unsigned char vme4[18975L];

short int     vmearrays = 4;
unsigned char *vmeArray[4] = {vme1, vme2, vme3, vme4};
long g_pArraySizes[ 4 ] = { 60000L, 60000L, 60000L, 18975L };