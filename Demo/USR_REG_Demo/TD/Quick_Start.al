...
<Project>
    ...
    <Source_Files>
        ...
        <SDC_FILE/>
        <CWC_FILE>debug_usr.cwc</CWC_FILE>
    </Source_Files>
    <TOP_MODULE>
        <LABEL/>
    ...
    <Property>
        <BitgenProperty::GeneralOption>
            ...
            <c>off</c>
            <data_ram/>
            <instruct_ram>F:/SVN_ELF2_SOC/trunk/Basic_Demo/USR_REG_Demo/Keil/Quick_Start.bin</instruct_ram>
            <s>off</s>
            <svf>on</svf>
    ...
    <Project_Settings>
        <Step_Last_Change>2018-09-05 19:04:33</Step_Last_Change>
