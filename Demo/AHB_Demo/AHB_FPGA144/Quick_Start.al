...
<Project>
    ...
    <Source_Files>
        ...
        <SDC_FILE/>
        <CWC_FILE>testAHB_BRAM.cwc</CWC_FILE>
    </Source_Files>
    <TOP_MODULE>
        <LABEL/>
    ...
    <Property>
        <BitgenProperty::GeneralOption>
            ...
            <c>off</c>
            <data_ram/>
            <instruct_ram>G:/ELF2_SOC_Release/trunk/Demo/AHB_Demo/AHB_SDK144/Quick_Start.bin</instruct_ram>
            <s>off</s>
            <svf>on</svf>
    ...
    <Project_Settings>
        <Step_Last_Change>2018-09-13 17:30:40</Step_Last_Change>
